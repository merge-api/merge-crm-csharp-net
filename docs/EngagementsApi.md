# Merge.CRMClient.Api.EngagementsApi
...
# **EngagementsCreate**
> EngagementResponse EngagementsCreate (string xAccountToken, EngagementEndpointRequest engagementEndpointRequest, bool? isDebugMode = null, bool? runAsync = null)
...
namespace Example
{
    public class EngagementsCreateExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new EngagementsApi(config);
            var xAccountToken = xAccountToken_example;  // string | Token identifying the end user.
            var engagementEndpointRequest = new EngagementEndpointRequest(); // EngagementEndpointRequest | 
            ...
            try
            {
                EngagementResponse result = apiInstance.EngagementsCreate(xAccountToken, engagementEndpointRequest, isDebugMode, runAsync);
...
namespace Example
{
    public class EngagementsListExample
    {
        public static void Main()
        {
            ...
            try
            {
                PaginatedEngagementList result = apiInstance.EngagementsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, includeRemoteFields, modifiedAfter, modifiedBefore, pageSize, remoteId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
namespace Example
{
    public class EngagementsMetaPatchRetrieveExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                MetaResponse result = apiInstance.EngagementsMetaPatchRetrieve(xAccountToken, id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling EngagementsApi.EngagementsMetaPatchRetrieve: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class EngagementsMetaPostRetrieveExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                MetaResponse result = apiInstance.EngagementsMetaPostRetrieve(xAccountToken);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling EngagementsApi.EngagementsMetaPostRetrieve: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> EngagementResponse EngagementsPartialUpdate (string xAccountToken, Guid id, PatchedEngagementEndpointRequest patchedEngagementEndpointRequest, bool? isDebugMode = null, bool? runAsync = null)
...
namespace Example
{
    public class EngagementsPartialUpdateExample
    {
        public static void Main()
        {
            ...
            var xAccountToken = xAccountToken_example;  // string | Token identifying the end user.
            var id = new Guid(); // Guid | 
            var patchedEngagementEndpointRequest = new PatchedEngagementEndpointRequest(); // PatchedEngagementEndpointRequest | 
            var isDebugMode = true;  // bool? | Whether to include debug fields (such as log file links) in the response. (optional) 
            var runAsync = true;  // bool? | Whether or not third-party updates should be run asynchronously. (optional) 

            try
            {
                EngagementResponse result = apiInstance.EngagementsPartialUpdate(xAccountToken, id, patchedEngagementEndpointRequest, isDebugMode, runAsync);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> PaginatedRemoteFieldClassList EngagementsRemoteFieldClassesList (string xAccountToken, string cursor = null, bool? includeDeletedData = null, bool? includeRemoteData = null, bool? includeRemoteFields = null, int? pageSize = null)
...
namespace Example
{
    public class EngagementsRemoteFieldClassesListExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                PaginatedRemoteFieldClassList result = apiInstance.EngagementsRemoteFieldClassesList(xAccountToken, cursor, includeDeletedData, includeRemoteData, includeRemoteFields, pageSize);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling EngagementsApi.EngagementsRemoteFieldClassesList: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
# **EngagementsRetrieve**
> Engagement EngagementsRetrieve (string xAccountToken, Guid id, bool? includeRemoteData = null, bool? includeRemoteFields = null)
...
namespace Example
{
    public class EngagementsRetrieveExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                Engagement result = apiInstance.EngagementsRetrieve(xAccountToken, id, includeRemoteData, includeRemoteFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling EngagementsApi.EngagementsRetrieve: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
