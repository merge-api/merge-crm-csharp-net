...
namespace Merge.CRMClient.Api
{
    ...
    public partial class PassthroughApi : IPassthroughApi
    {
        ...
        /// <returns></returns>
        public PassthroughApi(Merge.CRMClient.Client.Configuration configuration)
        {
        ...
        public PassthroughApi(Merge.CRMClient.Client.ISynchronousClient client, Merge.CRMClient.Client.IAsynchronousClient asyncClient, Merge.CRMClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.CRMClient.Client.ApiResponse<RemoteResponse> localVarResponse = PassthroughCreateWithHttpInfo(xAccountToken, dataPassthroughRequest);
        ...
        /// <param name="dataPassthroughRequest"></param>
        /// <returns>ApiResponse of RemoteResponse</returns>
        public Merge.CRMClient.Client.ApiResponse<RemoteResponse> PassthroughCreateWithHttpInfo(string xAccountToken, DataPassthroughRequest dataPassthroughRequest)
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.CRMClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling PassthroughApi->PassthroughCreate");

            // verify the required parameter 'dataPassthroughRequest' is set
            if (dataPassthroughRequest == null)
                throw new Merge.CRMClient.Client.ApiException(400, "Missing required parameter 'dataPassthroughRequest' when calling PassthroughApi->PassthroughCreate");
        ...
        {
            Merge.CRMClient.Client.ApiResponse<RemoteResponse> localVarResponse = await PassthroughCreateWithHttpInfoAsync(xAccountToken, dataPassthroughRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RemoteResponse)</returns>
        public async System.Threading.Tasks.Task<Merge.CRMClient.Client.ApiResponse<RemoteResponse>> PassthroughCreateWithHttpInfoAsync(string xAccountToken, DataPassthroughRequest dataPassthroughRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.CRMClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling PassthroughApi->PassthroughCreate");
