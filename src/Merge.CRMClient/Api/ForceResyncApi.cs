...
namespace Merge.CRMClient.Api
{
    ...
    public partial class ForceResyncApi : IForceResyncApi
    {
        ...
        /// <returns></returns>
        public ForceResyncApi(Merge.CRMClient.Client.Configuration configuration)
        {
        ...
        public ForceResyncApi(Merge.CRMClient.Client.ISynchronousClient client, Merge.CRMClient.Client.IAsynchronousClient asyncClient, Merge.CRMClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.CRMClient.Client.ApiResponse<List<SyncStatus>> localVarResponse = SyncStatusResyncCreateWithHttpInfo(xAccountToken);
        ...
        /// <param name="xAccountToken">Token identifying the end user.</param>
        /// <returns>ApiResponse of List&lt;SyncStatus&gt;</returns>
        public Merge.CRMClient.Client.ApiResponse<List<SyncStatus>> SyncStatusResyncCreateWithHttpInfo(string xAccountToken)
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.CRMClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling ForceResyncApi->SyncStatusResyncCreate");
        ...
        {
            Merge.CRMClient.Client.ApiResponse<List<SyncStatus>> localVarResponse = await SyncStatusResyncCreateWithHttpInfoAsync(xAccountToken, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;SyncStatus&gt;)</returns>
        public async System.Threading.Tasks.Task<Merge.CRMClient.Client.ApiResponse<List<SyncStatus>>> SyncStatusResyncCreateWithHttpInfoAsync(string xAccountToken, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.CRMClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling ForceResyncApi->SyncStatusResyncCreate");
