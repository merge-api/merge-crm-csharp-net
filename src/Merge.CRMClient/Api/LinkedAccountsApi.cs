...
namespace Merge.CRMClient.Api
{
    ...
    public partial class LinkedAccountsApi : ILinkedAccountsApi
    {
        ...
        /// <returns></returns>
        public LinkedAccountsApi(Merge.CRMClient.Client.Configuration configuration)
        {
        ...
        public LinkedAccountsApi(Merge.CRMClient.Client.ISynchronousClient client, Merge.CRMClient.Client.IAsynchronousClient asyncClient, Merge.CRMClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.CRMClient.Client.ApiResponse<PaginatedAccountDetailsAndActionsList> localVarResponse = LinkedAccountsListWithHttpInfo(category, cursor, endUserEmailAddress, endUserOrganizationName, endUserOriginId, endUserOriginIds, id, ids, includeDuplicates, integrationName, isTestAccount, pageSize, status);
        ...
        /// <param name="status">Filter by status. Options: &#x60;COMPLETE&#x60;, &#x60;INCOMPLETE&#x60;, &#x60;RELINK_NEEDED&#x60; (optional)</param>
        /// <returns>ApiResponse of PaginatedAccountDetailsAndActionsList</returns>
        public Merge.CRMClient.Client.ApiResponse<PaginatedAccountDetailsAndActionsList> LinkedAccountsListWithHttpInfo(string category = default(string), string cursor = default(string), string endUserEmailAddress = default(string), string endUserOrganizationName = default(string), string endUserOriginId = default(string), string endUserOriginIds = default(string), Guid? id = default(Guid?), string ids = default(string), bool? includeDuplicates = default(bool?), string integrationName = default(string), string isTestAccount = default(string), int? pageSize = default(int?), string status = default(string))
        {
            ...
            if (category != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "category", category));
            }
            if (cursor != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "end_user_email_address", endUserEmailAddress));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "end_user_origin_id", endUserOriginId));
            }
            if (endUserOriginIds != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "end_user_origin_ids", endUserOriginIds));
            }
            if (id != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "id", id));
            }
            if (ids != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "ids", ids));
            }
            if (includeDuplicates != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "include_duplicates", includeDuplicates));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "is_test_account", isTestAccount));
            }
            if (pageSize != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PaginatedAccountDetailsAndActionsList)</returns>
        public async System.Threading.Tasks.Task<Merge.CRMClient.Client.ApiResponse<PaginatedAccountDetailsAndActionsList>> LinkedAccountsListWithHttpInfoAsync(string category = default(string), string cursor = default(string), string endUserEmailAddress = default(string), string endUserOrganizationName = default(string), string endUserOriginId = default(string), string endUserOriginIds = default(string), Guid? id = default(Guid?), string ids = default(string), bool? includeDuplicates = default(bool?), string integrationName = default(string), string isTestAccount = default(string), int? pageSize = default(int?), string status = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
