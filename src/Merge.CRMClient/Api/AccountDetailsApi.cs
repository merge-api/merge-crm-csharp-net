...
namespace Merge.CRMClient.Api
{
    ...
    public partial class AccountDetailsApi : IAccountDetailsApi
    {
        ...
        /// <returns></returns>
        public AccountDetailsApi(Merge.CRMClient.Client.Configuration configuration)
        {
        ...
        public AccountDetailsApi(Merge.CRMClient.Client.ISynchronousClient client, Merge.CRMClient.Client.IAsynchronousClient asyncClient, Merge.CRMClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.CRMClient.Client.ApiResponse<AccountDetails> localVarResponse = AccountDetailsRetrieveWithHttpInfo(xAccountToken);
        ...
        /// <param name="xAccountToken">Token identifying the end user.</param>
        /// <returns>ApiResponse of AccountDetails</returns>
        public Merge.CRMClient.Client.ApiResponse<AccountDetails> AccountDetailsRetrieveWithHttpInfo(string xAccountToken)
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.CRMClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling AccountDetailsApi->AccountDetailsRetrieve");
        ...
        {
            Merge.CRMClient.Client.ApiResponse<AccountDetails> localVarResponse = await AccountDetailsRetrieveWithHttpInfoAsync(xAccountToken, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountDetails)</returns>
        public async System.Threading.Tasks.Task<Merge.CRMClient.Client.ApiResponse<AccountDetails>> AccountDetailsRetrieveWithHttpInfoAsync(string xAccountToken, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.CRMClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling AccountDetailsApi->AccountDetailsRetrieve");
