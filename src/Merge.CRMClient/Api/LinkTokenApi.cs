...
namespace Merge.CRMClient.Api
{
    ...
    public partial class LinkTokenApi : ILinkTokenApi
    {
        ...
        /// <returns></returns>
        public LinkTokenApi(Merge.CRMClient.Client.Configuration configuration)
        {
        ...
        public LinkTokenApi(Merge.CRMClient.Client.ISynchronousClient client, Merge.CRMClient.Client.IAsynchronousClient asyncClient, Merge.CRMClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.CRMClient.Client.ApiResponse<LinkToken> localVarResponse = LinkTokenCreateWithHttpInfo(endUserDetailsRequest);
        ...
        /// <param name="endUserDetailsRequest"></param>
        /// <returns>ApiResponse of LinkToken</returns>
        public Merge.CRMClient.Client.ApiResponse<LinkToken> LinkTokenCreateWithHttpInfo(EndUserDetailsRequest endUserDetailsRequest)
        {
            // verify the required parameter 'endUserDetailsRequest' is set
            if (endUserDetailsRequest == null)
                throw new Merge.CRMClient.Client.ApiException(400, "Missing required parameter 'endUserDetailsRequest' when calling LinkTokenApi->LinkTokenCreate");
        ...
        {
            Merge.CRMClient.Client.ApiResponse<LinkToken> localVarResponse = await LinkTokenCreateWithHttpInfoAsync(endUserDetailsRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LinkToken)</returns>
        public async System.Threading.Tasks.Task<Merge.CRMClient.Client.ApiResponse<LinkToken>> LinkTokenCreateWithHttpInfoAsync(EndUserDetailsRequest endUserDetailsRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'endUserDetailsRequest' is set
            if (endUserDetailsRequest == null)
                throw new Merge.CRMClient.Client.ApiException(400, "Missing required parameter 'endUserDetailsRequest' when calling LinkTokenApi->LinkTokenCreate");
