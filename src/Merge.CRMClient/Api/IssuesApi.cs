...
namespace Merge.CRMClient.Api
{
    ...
    public partial class IssuesApi : IIssuesApi
    {
        ...
        /// <returns></returns>
        public IssuesApi(Merge.CRMClient.Client.Configuration configuration)
        {
        ...
        public IssuesApi(Merge.CRMClient.Client.ISynchronousClient client, Merge.CRMClient.Client.IAsynchronousClient asyncClient, Merge.CRMClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Merge.CRMClient.Client.ApiResponse<PaginatedIssueList> localVarResponse = IssuesListWithHttpInfo(accountToken, cursor, endDate, endUserOrganizationName, firstIncidentTimeAfter, firstIncidentTimeBefore, includeMuted, integrationName, lastIncidentTimeAfter, lastIncidentTimeBefore, pageSize, startDate, status);
        ...
        /// <param name="status"> (optional)</param>
        /// <returns>ApiResponse of PaginatedIssueList</returns>
        public Merge.CRMClient.Client.ApiResponse<PaginatedIssueList> IssuesListWithHttpInfo(string accountToken = default(string), string cursor = default(string), string endDate = default(string), string endUserOrganizationName = default(string), DateTime? firstIncidentTimeAfter = default(DateTime?), DateTime? firstIncidentTimeBefore = default(DateTime?), string includeMuted = default(string), string integrationName = default(string), DateTime? lastIncidentTimeAfter = default(DateTime?), DateTime? lastIncidentTimeBefore = default(DateTime?), int? pageSize = default(int?), string startDate = default(string), string status = default(string))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "account_token", accountToken));
            }
            if (cursor != null)
            {
            ...
            if (endDate != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "end_date", endDate));
            }
            if (endUserOrganizationName != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "end_user_organization_name", endUserOrganizationName));
            }
            if (firstIncidentTimeAfter != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "first_incident_time_after", firstIncidentTimeAfter));
            }
            if (firstIncidentTimeBefore != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "first_incident_time_before", firstIncidentTimeBefore));
            }
            if (includeMuted != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "include_muted", includeMuted));
            }
            if (integrationName != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "integration_name", integrationName));
            }
            if (lastIncidentTimeAfter != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "last_incident_time_after", lastIncidentTimeAfter));
            }
            if (lastIncidentTimeBefore != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "last_incident_time_before", lastIncidentTimeBefore));
            }
            if (pageSize != null)
            {
            ...
            if (startDate != null)
            {
                localVarRequestOptions.QueryParameters.Add(Merge.CRMClient.Client.ClientUtils.ParameterToMultiMap("", "start_date", startDate));
            }
            if (status != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PaginatedIssueList)</returns>
        public async System.Threading.Tasks.Task<Merge.CRMClient.Client.ApiResponse<PaginatedIssueList>> IssuesListWithHttpInfoAsync(string accountToken = default(string), string cursor = default(string), string endDate = default(string), string endUserOrganizationName = default(string), DateTime? firstIncidentTimeAfter = default(DateTime?), DateTime? firstIncidentTimeBefore = default(DateTime?), string includeMuted = default(string), string integrationName = default(string), DateTime? lastIncidentTimeAfter = default(DateTime?), DateTime? lastIncidentTimeBefore = default(DateTime?), int? pageSize = default(int?), string startDate = default(string), string status = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Merge.CRMClient.Client.ApiResponse<Issue> localVarResponse = IssuesRetrieveWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id"></param>
        /// <returns>ApiResponse of Issue</returns>
        public Merge.CRMClient.Client.ApiResponse<Issue> IssuesRetrieveWithHttpInfo(Guid id)
        {
            Merge.CRMClient.Client.RequestOptions localVarRequestOptions = new Merge.CRMClient.Client.RequestOptions();
        ...
        {
            Merge.CRMClient.Client.ApiResponse<Issue> localVarResponse = await IssuesRetrieveWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Issue)</returns>
        public async System.Threading.Tasks.Task<Merge.CRMClient.Client.ApiResponse<Issue>> IssuesRetrieveWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
