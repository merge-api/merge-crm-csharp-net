...
namespace Merge.CRMClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PatchedOpportunityRequest")]
    public partial class PatchedOpportunityRequest : IEquatable<PatchedOpportunityRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedOpportunityRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchedOpportunityRequest {\n");
        ...
        {
            return this.Equals(input as PatchedOpportunityRequest);
        }

        /// <summary>
        /// Returns true if PatchedOpportunityRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedOpportunityRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedOpportunityRequest input)
        {
            if (input == null)
                return false;
