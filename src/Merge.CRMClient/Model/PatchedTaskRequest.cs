...
namespace Merge.CRMClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PatchedTaskRequest")]
    public partial class PatchedTaskRequest : IEquatable<PatchedTaskRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchedTaskRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PatchedTaskRequest {\n");
        ...
        {
            return this.Equals(input as PatchedTaskRequest);
        }

        /// <summary>
        /// Returns true if PatchedTaskRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchedTaskRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchedTaskRequest input)
        {
            if (input == null)
                return false;
