...
namespace Merge.CRMClient.Model
{
    ...
    public partial class AccountRequest : IEquatable<AccountRequest>, IValidatableObject
    {
        ...
        public AccountRequest(Guid? owner = default(Guid?), string name = default(string), string description = default(string), string industry = default(string), string website = default(string), int? numberOfEmployees = default(int?), DateTime? lastActivityAt = default(DateTime?), Dictionary<string, Object> integrationParams = default(Dictionary<string, Object>), Dictionary<string, Object> linkedAccountParams = default(Dictionary<string, Object>))
        {
            this.Owner = owner;
            this.Name = name;
