...
namespace Merge.CRMClient.Model
{
    ...
    public partial class TaskResponse : IEquatable<TaskResponse>, IValidatableObject
    {
        ...
        public TaskResponse(Task model = default(Task), List<WarningValidationProblem> warnings = default(List<WarningValidationProblem>), List<ErrorValidationProblem> errors = default(List<ErrorValidationProblem>), List<DebugModeLog> logs = default(List<DebugModeLog>))
        {
            // to ensure "model" is required (not null)
            this.Model = model ?? throw new ArgumentNullException("model is a required property for TaskResponse and cannot be null");
            // to ensure "warnings" is required (not null)
            this.Warnings = warnings ?? throw new ArgumentNullException("warnings is a required property for TaskResponse and cannot be null");
            // to ensure "errors" is required (not null)
            this.Errors = errors ?? throw new ArgumentNullException("errors is a required property for TaskResponse and cannot be null");
            this.Logs = logs;
        }
