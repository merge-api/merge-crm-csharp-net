...
namespace Merge.CRMClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommonModelScopesPostInnerDeserializerRequest")]
    public partial class CommonModelScopesPostInnerDeserializerRequest : IEquatable<CommonModelScopesPostInnerDeserializerRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonModelScopesPostInnerDeserializerRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommonModelScopesPostInnerDeserializerRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonModelScopesPostInnerDeserializerRequest" /> class.
        /// </summary>
        ...
        public CommonModelScopesPostInnerDeserializerRequest(string modelId = default(string), List<EnabledActionsEnum> enabledActions = default(List<EnabledActionsEnum>), List<string> disabledFields = default(List<string>))
        {
            // to ensure "modelId" is required (not null)
            this.ModelId = modelId ?? throw new ArgumentNullException("modelId is a required property for CommonModelScopesPostInnerDeserializerRequest and cannot be null");
            // to ensure "enabledActions" is required (not null)
            this.EnabledActions = enabledActions ?? throw new ArgumentNullException("enabledActions is a required property for CommonModelScopesPostInnerDeserializerRequest and cannot be null");
            // to ensure "disabledFields" is required (not null)
            this.DisabledFields = disabledFields ?? throw new ArgumentNullException("disabledFields is a required property for CommonModelScopesPostInnerDeserializerRequest and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonModelScopesPostInnerDeserializerRequest {\n");
        ...
        {
            return this.Equals(input as CommonModelScopesPostInnerDeserializerRequest);
        }

        /// <summary>
        /// Returns true if CommonModelScopesPostInnerDeserializerRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonModelScopesPostInnerDeserializerRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonModelScopesPostInnerDeserializerRequest input)
        {
            if (input == null)
                return false;
